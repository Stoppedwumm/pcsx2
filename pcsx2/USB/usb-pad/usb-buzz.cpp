...
namespace usb_pad
{
		...
		int request, int value, int index, int length, uint8_t* data)
	{
		...
		switch (request)
		{
			...
			case SET_REPORT:
				...
				p->actual_length = length; // needs proper testing
				return;
			default:
	...
	void BuzzDevice::SetBindingValue(USBDevice* dev, u32 bind_index, float value) const
	{
		...
		{
			case CID_BUZZ_PLAYER1_RED:
				s->data.player1_red = (value >= 0.5f);
				break;
			case CID_BUZZ_PLAYER1_BLUE:
				s->data.player1_blue = (value >= 0.5f);
				break;
			case CID_BUZZ_PLAYER1_ORANGE:
				s->data.player1_orange = (value >= 0.5f);
				break;
			case CID_BUZZ_PLAYER1_GREEN:
				s->data.player1_green = (value >= 0.5f);
				break;
			case CID_BUZZ_PLAYER1_YELLOW:
				s->data.player1_yellow = (value >= 0.5f);
				break;
			case CID_BUZZ_PLAYER2_RED:
				s->data.player2_red = (value >= 0.5f);
				break;
			case CID_BUZZ_PLAYER2_BLUE:
				s->data.player2_blue = (value >= 0.5f);
				break;
			case CID_BUZZ_PLAYER2_ORANGE:
				s->data.player2_orange = (value >= 0.5f);
				break;
			case CID_BUZZ_PLAYER2_GREEN:
				s->data.player2_green = (value >= 0.5f);
				break;
			case CID_BUZZ_PLAYER2_YELLOW:
				s->data.player2_yellow = (value >= 0.5f);
				break;
			case CID_BUZZ_PLAYER3_RED:
				s->data.player3_red = (value >= 0.5f);
				break;
			case CID_BUZZ_PLAYER3_BLUE:
				s->data.player3_blue = (value >= 0.5f);
				break;
			case CID_BUZZ_PLAYER3_ORANGE:
				s->data.player3_orange = (value >= 0.5f);
				break;
			case CID_BUZZ_PLAYER3_GREEN:
				s->data.player3_green = (value >= 0.5f);
				break;
			case CID_BUZZ_PLAYER3_YELLOW:
				s->data.player3_yellow = (value >= 0.5f);
				break;
			case CID_BUZZ_PLAYER4_RED:
				s->data.player4_red = (value >= 0.5f);
				break;
			case CID_BUZZ_PLAYER4_BLUE:
				s->data.player4_blue = (value >= 0.5f);
				break;
			case CID_BUZZ_PLAYER4_ORANGE:
				s->data.player4_orange = (value >= 0.5f);
				break;
			case CID_BUZZ_PLAYER4_GREEN:
				s->data.player4_green = (value >= 0.5f);
				break;
			case CID_BUZZ_PLAYER4_YELLOW:
				s->data.player4_yellow = (value >= 0.5f);
				break;
			default:
				break;
		}
